...
> **📸 实践图例**
> *<!-- TODO: 在此补充 Init 提示词回显或聊天界面 截图 -->*

## 步骤 3: Iteration Issues (缺陷修改)
...
> **📸 实践图例**
> *<!-- TODO: 在此补充 EA中提交缺陷或代码修复 截图 -->*

## 步骤 4: Design Audit (架构-代码审计 / Traceability)
...
> **📸 实践图例**
> *<!-- TODO: 在此补充 架构审计报告/EA反向一致性修正 截图 -->*

## 步骤 5: Wrap-up & Iteration Summary (迭代收尾与 Git 提交)
...
> **📸 实践图例**
> *<!-- TODO: 在此补充 生成的 Git Commit Message 或 收尾总结 截图 -->*

## 步骤 6: Weekly Report (沟通管理 / 周报)
- **触发**：`打开 Copilot（Weekly Report）`。
- **目的**：为干系人生成易于理解的管理层周报 (`implementation/reports/xxx.md`)。涵盖执行摘要和表格级别的任务进展。

> **📸 实践图例**
> *<!-- TODO: 在此补充 周报渲染出的 Markdown 界面 截图 -->*

---
完成 步骤 6，即宣告本次敏捷 Sprint 从架构发起到收尾的闭环圆满跑过一轮。然后将代码 Push 并同步 EA 模型库准备下一次迭代。