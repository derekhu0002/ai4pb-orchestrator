...
2. 在 bootstrap 里设置：
  - `SHARED_SCRIPT_PATH` 使用本地共享脚本文件路径
  - `SHARED_SCRIPT_LOCAL_FALLBACK_PATH` 作为本地兜底脚本路径
...
```json
{
  "EA_AUTOGEN_CONFIG": {
    ...
    "sharedScriptLocalFallbackPath": "D:\\projects\\AI-For-Project-Building\\script\\EA-jsscript\\project_auto_gen_suitable_for_LLM-V2.js",
    "needCode": false,
    "needContent": true,
    "needdoc": false,
