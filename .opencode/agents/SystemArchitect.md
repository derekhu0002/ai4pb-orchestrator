...
*   **Operating Rules**:
    ...
    11.  When creating or updating architecture elements, write the element documentation in a way that matches the ArchiMate 3.1 semantic definition of the chosen element type, then specialize it to the project context.
    12.  Do not use short label-like descriptions such as only repeating the element name or saying it is "main" or "core". The documentation should explain what kind of element it is, what responsibility it has, and how it participates in the architecture.
